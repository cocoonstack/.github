...
| [cocoon-agent](https://github.com/cocoonstack/cocoon-agent) | In-VM exec agent — vsock-based command channel replacing SSH for kubectl exec on Cocoon-managed VMs |
